...
namespace TestFramework_Upesh
{
    ...
    public class tstStaff
    {
        ...
        public void AddressLine1PropertyOK()
        {
            ...
            //assign the test data to the property
            AStaff.AddressLine1 = TestAddress1;
            //test to see that the two values match
            Assert.AreEqual(AStaff.AddressLine1, TestAddress1);
        }
        ...
        public void AddressLine2PropertyOK()
        {
            ...
            //assign the test data to the property
            AStaff.AddressLine2 = TestAddress2;
            //test to see that the two values match
            Assert.AreEqual(AStaff.AddressLine2, TestAddress2);
        }
        ...
        public void CityPropertyOK()
        {
            ...
            //assign the test data to the property
            AStaff.City = TestCity;
            //test to see that the two values match
            Assert.AreEqual(AStaff.City, TestCity);
        }
        ...
        public void PostCodePropertyOK()
        {
            ...
            //assign the test data to the property
            AStaff.PostCode = TestPostCode;
            //test to see that the two values match
            Assert.AreEqual(AStaff.PostCode, TestPostCode);
        }
        ...
        public void DateOfBirthPropertyOK()
        {
            ...
            //assign the test data to the property
            AStaff.DateOfBirth = TestDateOfBirth;
            //test to see that the two values match
            Assert.AreEqual(AStaff.DateOfBirth, TestDateOfBirth);
        }
        ...
        public void TelephonePropertyOK()
        {
            ...
            //assign the test data to the property
            AStaff.Telephone = TestTelephone;
            //test to see that the two values match
            Assert.AreEqual(AStaff.Telephone, TestTelephone);
        }
        ...
        public void ValidMethodOK()
        {
            ...
            //invoke the method
            OK = AStaff.Valid(StaffID, FirstName, LastName, AddressLine1, AddressLine2, City, PostCode, DateOfBirth, Telephone, Email);
        ...
        public void LastNameExMin()
        {
            ...
            bool OK = false;
            //create some test data to assign to the property
            Int32 StaffID = 100; string FirstName = "Upesh";
            //Because the test is related to this variable, this may change
            string LastName = "";
            string AddressLine1 = "40 Western Road";
            string AddressLine2 = "Flat1245";
